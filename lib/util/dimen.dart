/// Various dimensional constants for the app
class Dimen {
  // DON'T ERASE THE THEORETICALLY UNNECESSARY .0
  // OR CODE WON'T COMPILE, ALTHOUGH IT MAKES NO SENSE

  // ignore: prefer_int_literals, public_member_api_docs
  static const double FONT_TINY = 12.0;
  // ignore: prefer_int_literals, public_member_api_docs
  static const double FONT_SMALL = 16.0;
  // ignore: prefer_int_literals, public_member_api_docs
  ...
  // ignore: prefer_int_literals, public_member_api_docs
  static const double SPACING_SMALL = 16.0;
  // ignore: prefer_int_literals, public_member_api_docs
  static const double SPACING_NORMAL = 24.0;
  // ignore: prefer_int_literals, public_member_api_docs
